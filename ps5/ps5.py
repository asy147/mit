    ...
    def is_phrase_in(self, text):
        ...
        for letter in text.lower():
            if letter in string.ascii_lowercase:
                ...
                #print(new_letter)
                strip_text += new_letter
        strip_text = ' '.join(strip_text.split())
        #print(strip_text)
        for word in self.phrase.split(" "):
            if word + "s" in strip_text:
                return False
        return self.phrase in strip_text
...
class TitleTrigger(PhraseTrigger):
    ...
    def evaluate(self, story):
        ...
        #print(PhraseTrigger.is_phrase_in(self, story.get_title()))
...
class BeforeTrigger(TimeTrigger):
    def evaluate(self, story):
#        print("\n",story.get_pubdate().time())
#        print(self.time.time() > (story.get_pubdate().time()))
...
#            stories = process("https://www.reddit.com/.rss")
